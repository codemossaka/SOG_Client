...
Окно подключения.  
![Окно подключения](../Images/connect window.png) 
После подключения при режиме "Аккорды" открывается окно демонстрации аккордов.  
![Окно демонстрации аккордов](../Images/presentation window in chords mode.png)  
При режиме "Текст" открывается окно демонстрации текста.  
![Окно демонстрации текста](../Images/presentation window in text mode.png)  
Режим отображеня можно изменить, открыв шторку смены режима.
![Шторку смены режима](../Images/chage mode curtain.png)  
